...
Functional Intent: Active Clinical Routing Engine — detects user state and routes to correct therapeutic modality. 25 Modalities.
Authority Level: Level 2 (High) — this document drives AI behavior, not just data reference.
Linked Entities: sys_Instructions_Main, meta_Clinical_Triage_Logic, ShareWithMe System Core.
...
meta
File Name
meta_ShareWithMe_Clinical_Routing_Library_v2.md
Gem Name
ShareWithMe
Target Folder
ShareWithMe
...
2026-03-28
Keywords
#Therapy #ClinicalRouting #Psychology #ShareWithMe #25Modalities #RoutingEngine
